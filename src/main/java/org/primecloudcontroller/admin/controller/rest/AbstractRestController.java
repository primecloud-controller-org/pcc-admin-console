...
import org.primecloudcontroller.admin.controller.AbstractController;
...
public abstract class AbstractRestController extends AbstractController {
    ...
    public RestResponse handler(Exception e) {
        if (e instanceof ApplicationException) {
            ...
            String message = messageSource.getMessage(ex.getCode(), ex.getAdditions(), ex.getCode(), null);
            return new RestResponse(ex.getCode(), message);
        } else {
            e.printStackTrace();
